...
Generated by `python scripts/dump_prompts.py` from the live prompt builders in `app/rules.py` and `app/generator.py`. Do not edit by hand. Rules version 0.2.0.
...
## Rulebook (version 0.2.0, 2026-09-06)
