...
Generated by `node scripts/dump-prompts.js` from the live prompt builders in `app/lib/rules.js` and `app/lib/generator.js`. Do not edit by hand. Rules version 0.1.0.
